...
public class ViewAppointment extends GPSISPopup implements ActionListener {
	...
	private CalendarAppointment selectedCalendarAppointment;

	public ViewAppointment(CalendarAppointment cA) {
		super("Modify Calendar Appointment");
		this.selectedCalendarAppointment = cA;
